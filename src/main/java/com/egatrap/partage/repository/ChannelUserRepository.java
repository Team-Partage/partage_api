...
//      Pessimistic Locking
    ...
    Boolean existsByChannel_ChannelIdAndUser_UserId(String channelId, String userId);

    Optional<ChannelUserEntity> findByChannel_ChannelIdAndUser_UserId(String channelId, String userId);
}
